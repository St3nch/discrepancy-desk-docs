...
- `05-implementation-planning/m06a-vtt-v1-under-test-candidate-package.md` — implemented at `a96928f`; Rust validation, adversarial review, and owner closure pending
...
- `08-audits/m06a-vtt-v1-implementation-return.md` — exact D045 implementation/evidence return; Rust validation and review gates remain open
