...
This package prepares the next stdlib-first parser candidate after corrected SRT. It does not authorize
implementation, admission, canonical parsing, existing-Vault retrofit, JSON, or Phase 3B.
